...
counts_matrix <- read.table("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/laca6459/MASTER_CLASS/data/salmon.merged.gene_counts.tsv", #File Path to Data
...
deseq_samples$time_point <- time_values #Add column for time points

deseq_samples$replicate <- replicate_values #Add column for replicate
