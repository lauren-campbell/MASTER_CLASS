...
#SBATCH --mail-user=laca6459@colorado.edu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=6gb
...
--outdir /scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/laca6459/MASTER_CLASS/lessons/04_RNAseq_Dox/01_Mouse_dox_wt/dox_long/output \
...
--gtf /scratch/Shares/rinnclass/MASTER_CLASS/GENOMES/ME/gencode.vM25.annotation.gtf \
--pseudo_aligner salmon \
--gencode \
--email laca6459@colorado.edu \
-c nextflow.config
