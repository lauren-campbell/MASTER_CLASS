...
gene_values <- filtered_res_df %>%
  filter(gene_name %in% genes) #look at gene name and match to "genes" list
...
ggplot(gene_values, 
  ...
  geom_point()  #FAVORITE GRAPH FOR THIS INFO
...
source("/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/laca6459/MASTER_CLASS/util/plot_theme.R")
